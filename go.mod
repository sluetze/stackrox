...
replace github.com/stackrox/helmtest => github.com/stackrox/helmtest v0.0.0-20231219074707-23740164c5ff

replace helm.sh/helm/v3 => github.com/porridge/helm/v3 v3.9.0-rc.1.0.20231218102930-a0422acfa633
