...
func NewIndexer(db postgres.DB) search.Searcher {
	return pgSearch.NewSearcher(db, v1.SearchCategory_COMPONENT_VULN_EDGE, metricSetIndexOperationDurationTime)
}

func metricSetIndexOperationDurationTime(t time.Time, op ops.Op) {
	metrics.SetIndexOperationDurationTime(t, op, "ComponentCVEEdge")
}
