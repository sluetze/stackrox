...
func NewIndexer(db postgres.DB) search.Searcher {
	return pgSearch.NewSearcher(db, v1.SearchCategory_CLUSTER_VULNERABILITIES, metricSetIndexOperationDurationTime)
}

func metricSetIndexOperationDurationTime(t time.Time, op ops.Op) {
	metrics.SetIndexOperationDurationTime(t, op, "ClusterCVE")
}
