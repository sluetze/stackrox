...
type AzureProviderMetadata_ClusterType int32

const (
	AzureProviderMetadata_UNKNOWN AzureProviderMetadata_ClusterType = 0
	AzureProviderMetadata_AKS     AzureProviderMetadata_ClusterType = 1
	AzureProviderMetadata_ARO     AzureProviderMetadata_ClusterType = 2
)

var AzureProviderMetadata_ClusterType_name = map[int32]string{
	0: "UNKNOWN",
	1: "AKS",
	2: "ARO",
}

var AzureProviderMetadata_ClusterType_value = map[string]int32{
	"UNKNOWN": 0,
	"AKS":     1,
	"ARO":     2,
}

func (x AzureProviderMetadata_ClusterType) String() string {
	return proto.EnumName(AzureProviderMetadata_ClusterType_name, int32(x))
}

func (AzureProviderMetadata_ClusterType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bd4108636841f8d0, []int{2, 0}
}
...
type AzureProviderMetadata struct {
	...
	ClusterType          AzureProviderMetadata_ClusterType `protobuf:"varint,4,opt,name=cluster_type,json=clusterType,proto3,enum=storage.AzureProviderMetadata_ClusterType" json:"cluster_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
func (m *AzureProviderMetadata) GetClusterName() string {
	if m != nil {
		return m.ClusterName
	}
	return ""
...
func (m *AzureProviderMetadata) GetClusterId() string {
	if m != nil {
		return m.ClusterId
	}
	return ""
...
func (m *AzureProviderMetadata) GetClusterType() AzureProviderMetadata_ClusterType {
	if m != nil {
		return m.ClusterType
	}
	return AzureProviderMetadata_UNKNOWN
}
...
func init() {
	...
	proto.RegisterEnum("storage.AzureProviderMetadata_ClusterType", AzureProviderMetadata_ClusterType_name, AzureProviderMetadata_ClusterType_value)
...
var fileDescriptor_bd4108636841f8d0 = []byte{
	...
	,
}
...
func (m *AzureProviderMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ClusterType != 0 {
		i = encodeVarintCluster(dAtA, i, uint64(m.ClusterType))
		i--
		dAtA[i] = 0x20
	}
...
func (m *AzureProviderMetadata) Size() (n int) {
	...
	if m.ClusterType != 0 {
		n += 1 + sovCluster(uint64(m.ClusterType))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ClusterType |= AzureProviderMetadata_ClusterType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
